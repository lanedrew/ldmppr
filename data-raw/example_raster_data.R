...
terra::varnames(cropped_rasters[[1]]) <- "Snodgrass_aspect_southness_1m"
names(cropped_rasters[[2]]) <- "Snodgrass_wetness_index_1m"
terra::varnames(cropped_rasters[[2]]) <- "Snodgrass_wetness_index_1m"
names(cropped_rasters[[3]]) <- "Snodgrass_slope_1m"
terra::varnames(cropped_rasters[[3]]) <- "Snodgrass_slope_1m"
names(cropped_rasters[[4]]) <- "Snodgrass_DEM_1m"
terra::varnames(cropped_rasters[[4]]) <- "Snodgrass_DEM_1m"
